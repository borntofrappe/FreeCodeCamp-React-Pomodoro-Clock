The application has been developed with the `create-react-app` utility. It is however available CodePen, and passing  _every single_ test, right [here](https://codepen.io/borntofrappe/full/bjvmaJ/).
